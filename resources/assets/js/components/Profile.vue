  ...
  <div class="section profile-heading">
    <div class="columns">
      ...
      <div class="column is-2 name">
        <p>
          <span class="title is-bold">{{ user.first_name }} {{ user.last_name }}</span>
        </p>
        <p class="tagline">{{ user.bio }}</p>
      </div>
      <div class="column is-2 followers has-text-centered">
        <p class="stat-val">123123</p>
        <p class="stat-key">quizzes written</p>
      </div>
      <div class="column is-2 following has-text-centered">
        <p class="stat-val">100%</p>
        <p class="stat-key">last score</p>
      </div>
      <div class="column is-2 likes has-text-centered">
        <p class="stat-val">11</p>
        <p class="stat-key">perfect scores</p>
      </div>
      <div class="column is-2 likes has-text-centered">
        <p class="stat-val">Javascript</p>
        <p class="stat-key">favorite language</p>
      </div>
    </div>
  </div>
