...
The value 42 has an intrinsic type of number, and its type cannot be changed. Another value, like "42" with the string type, can be cre‐ ated from the number value 42 through a process called coercion (see Chapter 4).
